...
The pure discovery model lives in ``ux_compose.routing.core``. This module
only binds callables onto FastAPI/Starlette routes. Page units and path
law never import FastAPI.
"""
