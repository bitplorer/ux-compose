...
CATALOG: dict[str, KitEntry] = {
    ...
    "rating": {
        ...
        "stem": "rating",
        "exports": ["Rating"],
        "description": "Named stars. one|two|three|four|five — never MorphState(int).",
        "css": False,
        "page": True,
    },
    "kanban": {
        "name": "Kanban",
        "module": "ux_compose.kit.kanban",
        "stem": "kanban",
        "exports": ["Kanban"],
        "description": "Three lanes of ids. Move is public. Archive spends a Cap.",
        "css": False,
        "page": True,
    },
    "timeline": {
        ...
        "stem": "timeline",
        "exports": ["Timeline"],
        "description": "Named filter. Events silent. Empty lane is a first-class row.",
        "css": False,
        "page": True,
    },
    "kpi": {
        "name": "Kpi",
        "module": "ux_compose.kit.kpi",
        "stem": "kpi",
        "exports": ["Kpi"],
        "description": "Dashboard numbers in RefState. Reset spends admin.reset.",
        "css": False,
        "page": True,
    },
    "slider": {
        ...
        "stem": "slider",
        "exports": ["Slider"],
        "description": "Percent silent. Named band MorphState. Stepped buttons, not range.",
        "css": False,
        "page": True,
    },
    "lightbox": {
        "name": "Lightbox",
        "module": "ux_compose.kit.lightbox",
        "stem": "lightbox",
        "exports": ["Lightbox"],
        "description": "Named slides. Overlay presence. Swipe on Prev / Next.",
        "css": False,
        "page": True,
    },
    "wishlist": {
        "name": "Wishlist",
        "module": "ux_compose.kit.wishlist",
        "stem": "wishlist",
        "exports": ["Wishlist"],
        "description": "Ids silent. Heart is public. Saving is not placing.",
        "css": False,
        "page": True,
    },
    "progress": {
        ...
        "stem": "progress",
        "exports": ["Progress"],
        "description": "Pct silent. Phase idle/run/done. Band is a name.",
        "css": False,
        "page": True,
    },
    "empty": {
        "name": "Empty",
        "module": "ux_compose.kit.empty",
        "stem": "empty",
        "exports": ["Empty"],
        "description": "empty|loading|error|ready. Never a blank stage.",
        "css": False,
        "page": True,
    },
    "presence": {
        "name": "Presence",
        "module": "ux_compose.kit.presence",
        "stem": "presence",
        "exports": ["Presence"],
        "description": "Self named. Peers silent. here / away / focus.",
        "css": False,
        "page": True,
    },
    "chips": {
        "name": "Chips",
        "module": "ux_compose.kit.chips",
        "stem": "chips",
        "exports": ["Chips"],
        "description": "Tag set as RefState. Add/remove names. Stamp dirties.",
        "css": False,
        "page": True,
    },
    "skeleton": {
        ...
        "stem": "skeleton",
        "exports": ["Skeleton"],
        "description": "Loading MorphState. Pulse bars keep stable ids.",
        "css": False,
        "page": True,
    },
}
