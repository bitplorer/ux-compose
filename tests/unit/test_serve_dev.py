...
from ux_compose.cli.serve_dev import (
    CHANNEL_PATH_PREFIX,
    RELOAD_EXCLUDES,
    RELOAD_INCLUDES,
    listen_loopback,
...
from ux_compose.cli.serve_restart import PID_NAME, pid_path, restart_channel
...
def test_dead_names_are_gone():
    src = (ROOT / "src" / "ux_compose" / "cli" / "serve_dev.py").read_text(encoding="utf-8")
