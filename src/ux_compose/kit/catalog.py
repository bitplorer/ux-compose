...
CATALOG: dict[str, KitEntry] = {
    ...
    "sheet": {
        ...
        "stem": "sheet",
        "exports": ["Sheet"],
        "description": "Edge panel. Same shape as a dialog, different CSS.",
        "css": False,
        "page": True,
    },
    "toast": {
    ...
    "pagination": {
        ...
        "stem": "pagination",
        "exports": ["Pagination"],
        "description": "Opaque page keys. Channel refuses quantity MorphState.",
        "css": False,
        "page": True,
    },
    "combobox": {
    ...
    "carousel": {
        ...
        "stem": "carousel",
        "exports": ["Carousel"],
        "description": "Named slides. Neighbor keys, never +1.",
        "css": False,
        "page": True,
    },
    "calendar": {
    ...
    "contextmenu": {
        ...
        "stem": "contextmenu",
        "exports": ["ContextMenu"],
        "description": "Click or longpress the same trigger. Items stay on click.",
        "css": False,
        "page": True,
    },
    "typeahead": {
