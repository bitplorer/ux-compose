...
**UI kit:** [docs/guides/UI.md](docs/guides/UI.md) — pick-and-use Components from the kit catalog.
...
ux-compose   → create-app · build · serve · deploy · HMR
```

`App.mount` is a library mount for tests and surfaces — not a product verb.
Shape: [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md).

Public imports are from `ux_compose` (`App`, `Component`, `div`, `button`, `act`, …).
...
| Pick-and-use UI (kit catalog) | [docs/guides/UI.md](docs/guides/UI.md) |
...
| Full example map (Atelier) | [examples/README.md](examples/README.md) |
